		...
		<div className="overflow-hidden rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface)]">
			...
			<div className="space-y-5 px-5 py-5">
				...
				<button
					...
					className="flex w-full items-center justify-center gap-3 rounded-full bg-[var(--color-primary)] px-8 py-4 text-[0.7rem] font-semibold uppercase tracking-[0.22em] text-[var(--color-bg-deep)] transition-all hover:bg-[var(--color-primary-bright)] disabled:cursor-not-allowed disabled:opacity-40"
				>
					{processing ? (
						<>
